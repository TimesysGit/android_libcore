...
public final class NativeCrypto {
    ...
    public static native long EVP_DigestInit(long evp_md, int evp_flags);
    ...
    public static int X509_NAME_hash_old(X500Principal principal) {
        /* Hashing a CA name is an allowable usage of the MD5 digest under FIPS.
         * Therefore use MD5 mode that passes EVP_MD_CTX_FLAG_NON_FIPS_ALLOW.
         * The OpenSSL function of the same name (X509_NAME_hash_old) that
         * this function is meant to emulate does the same.
         */
        return X509_NAME_hash(principal, "MD5_FIPS");
    }
